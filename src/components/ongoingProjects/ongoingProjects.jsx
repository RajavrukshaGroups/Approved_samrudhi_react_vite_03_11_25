...
import VideoModal from "../../components/ModalVideo/index.jsx";
        ...
        <div className="row">
          <div className="col-md-11 mx-auto">
            <div className="tour-inn" data-aos="fade-up">
              <img src={'https://rajavrukshagroup.in/wp-content/uploads/2023/12/pexels-jahoo-clouseau-388415-1536x810.jpg'} alt="img" />
